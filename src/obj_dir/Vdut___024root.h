...
class Vdut___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ testing__DOT__main_cpu__DOT__main_cpu__DOT__extactive;
    ...
    CData/*0:0*/ testing__DOT__main_cpu__DOT__main_cpu__DOT__main_controlpath__DOT__saveaddress;
    ...
    CData/*5:0*/ testing__DOT__main_cpu__DOT__main_cpu__DOT__main_controlpath__DOT__jump_conditions__DOT__extended_offset;
